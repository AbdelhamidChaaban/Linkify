...
class InsightsManager {
    ...
    bindEvents() {
        ...
        // Fix for landscape mode: CSS now handles scrolling via touch-action
        // No JavaScript touch handlers needed - they interfere with native scrolling
    }
    
    // setupLandscapeTouchHandling() - REMOVED
    // This was interfering with native CSS scrolling behavior
    // CSS now handles all touch scrolling via touch-action property
